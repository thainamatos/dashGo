      ...
      <Flex align="center" ml="auto">
        ...
        <Flex align="center">
            <Box mr="4" textAlign="right">
                ...
                <Text>Thainá Matos</Text>
                <Text color="gray.300" fontSize="small">thainamatos.if@hotmail.com</Text>

            </Box>
            <Avatar size="md" name="Thainá Matos" src="https://github.com/thainamatos.png"/>
        </Flex>
      </Flex>
    </Flex>
  );
